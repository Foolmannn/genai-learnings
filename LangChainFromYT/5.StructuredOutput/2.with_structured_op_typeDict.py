...
class Review(TypedDict):
    ...
    name: Annotated[Optional[str],"Write the name of the reviewer"] # due to optional the name will not exits 
...
print(result['sentiment']) # now wher the there is no cons in review. 
